...
const en: Dict = {
 ...
 about:'About',versionOffline:'Version 1.2.0 — personal income and expense tracking, offline and account-free.',registerIncome:'Add income',registerExpense:'Add expense',newInput:'New inflow',newOutput:'New outflow',
 ...
 privacyLocalOnly:'Financial data is stored locally for core features.',dataIntegrityNote:'Back up before resetting or replacing the device.',openSource:'Open source',customCategory:'Custom categories',confirmDeleteTransaction:'Delete this transaction?',languageReload:'Language changed.',selectedCurrency:'Selected currency',fontSize:'Text size',fontSmall:'Small',fontDefault:'Default',fontLarge:'Large',fontXlarge:'Extra large',fontXxlarge:'Largest',homeCards:'Home cards',addHomeCard:'Add card',moveLeft:'Move left',moveRight:'Move right',removeHomeCard:'Remove from home',restoreHomeCards:'Restore default cards',balanceCard:'Current balance',monthIncomeCard:'Current month income',monthExpenseCard:'Current month expense',monthBalanceCard:'Current month balance',topCategoryCard:'Top expense category',transactionCountCard:'Transaction count',latestTransactionCard:'Latest transaction',currencySummaryCard:'Currency summary',cardHint:'Drag the dotted handle to move the whole card with its information.'
};
...
const ru: Dict = {
 ...
 finalDeleteWarning:'Подтверждение: все операции и пользовательские категории будут удалены.',finalDelete:'Удалить навсегда',cancel:'Отмена',about:'О программе',versionOffline:'Версия 1.2.0 — личный учёт доходов и расходов, офлайн.',registerIncome:'Добавить доход',registerExpense:'Добавить расход',newInput:'Новый доход',newOutput:'Новый расход',
...
const ar: Dict = {
 ...
 finalDeleteWarning:'تأكيد نهائي: سيتم حذف جميع المعاملات والفئات المخصصة.',finalDelete:'حذف نهائي',cancel:'إلغاء',about:'حول التطبيق',versionOffline:'الإصدار 1.2.0 — إدارة شخصية للدخل والمصروفات دون اتصال.',registerIncome:'إضافة دخل',registerExpense:'إضافة مصروف',newInput:'دخل جديد',newOutput:'مصروف جديد',
