...
const fa: Dict = {
 ...
 about:'درباره',versionOffline:'نسخه ۱٫۴٫۱ — مدیریت شخصی درآمد و هزینه، آفلاین و بدون نیاز به حساب کاربری.',registerIncome:'ثبت درآمد',registerExpense:'ثبت هزینه',newInput:'ورودی جدید',newOutput:'خروجی جدید',
...
const en: Dict = {
 ...
 about:'About',versionOffline:'Version 1.4.1 — personal income and expense tracking, offline and account-free.',registerIncome:'Add income',registerExpense:'Add expense',newInput:'New inflow',newOutput:'New outflow',
...
const ru: Dict = {
 ...
 finalDeleteWarning:'Подтверждение: все операции и пользовательские категории будут удалены.',finalDelete:'Удалить навсегда',cancel:'Отмена',about:'О программе',versionOffline:'Версия 1.4.1 — личный учёт доходов и расходов, офлайн.',registerIncome:'Добавить доход',registerExpense:'Добавить расход',newInput:'Новый доход',newOutput:'Новый расход',
...
const ar: Dict = {
 ...
 finalDeleteWarning:'تأكيد نهائي: سيتم حذف جميع المعاملات والفئات المخصصة.',finalDelete:'حذف نهائي',cancel:'إلغاء',about:'حول التطبيق',versionOffline:'الإصدار 1.4.1 — إدارة شخصية للدخل والمصروفات دون اتصال.',registerIncome:'إضافة دخل',registerExpense:'إضافة مصروف',newInput:'دخل جديد',newOutput:'مصروف جديد',
