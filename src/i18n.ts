...
export type TranslationKey =
  ...
  | 'monthBalanceCard'|'topCategoryCard'|'transactionCountCard'|'latestTransactionCard'|'currencySummaryCard'|'cardHint';
