...
export type TranslationKey =
  ...
  | 'fontSize'|'fontSmall'|'fontDefault'|'fontLarge'|'fontXlarge'|'fontXxlarge'|'homeCards'|'addHomeCard'
  | 'moveLeft'|'moveRight'|'removeHomeCard'|'restoreHomeCards'|'balanceCard'|'monthIncomeCard'|'monthExpenseCard'
  | 'monthBalanceCard'|'topCategoryCard'|'transactionCountCard'|'latestTransactionCard'|'currencySummaryCard'|'cardHint'|'homeInsights'|'homeInsightHint'|'previousInsight'|'nextInsight';

type Dict = Record<TranslationKey,string>;

const fa: Dict = {
 appName:'Cashio',tagline:'مدیریت ساده و آفلاین',currentBalance:'موجودی فعلی',recordedOnDevice:'اطلاعات روی همین دستگاه ذخیره می‌شود',
 ...
 about:'درباره',versionOffline:'نسخه ۱٫۲٫۰ — مدیریت شخصی درآمد و هزینه، آفلاین و بدون نیاز به حساب کاربری.',registerIncome:'ثبت درآمد',registerExpense:'ثبت هزینه',newInput:'ورودی جدید',newOutput:'خروجی جدید',
 ...
 privacyLocalOnly:'داده‌های مالی برای قابلیت اصلی در همین دستگاه نگهداری می‌شوند.',dataIntegrityNote:'قبل از تعویض یا پاک‌سازی دستگاه، پشتیبان بگیرید.',openSource:'کد منبع پروژه در دسترس است',customCategory:'دسته‌های سفارشی',confirmDeleteTransaction:'این تراکنش حذف شود؟',languageReload:'زبان برنامه تغییر کرد.',selectedCurrency:'ارز انتخاب‌شده',fontSize:'اندازه متن',fontSmall:'کوچک',fontDefault:'متوسط',fontLarge:'بزرگ',fontXlarge:'خیلی بزرگ',fontXxlarge:'بسیار بزرگ',homeCards:'کارت‌های صفحه خانه',addHomeCard:'افزودن کارت',moveLeft:'جابه‌جایی به چپ',moveRight:'جابه‌جایی به راست',removeHomeCard:'حذف از خانه',restoreHomeCards:'بازگردانی کارت‌های پیش‌فرض',balanceCard:'موجودی فعلی',monthIncomeCard:'درآمد ماه جاری',monthExpenseCard:'هزینه ماه جاری',monthBalanceCard:'مانده ماه جاری',topCategoryCard:'بیشترین دسته هزینه',transactionCountCard:'تعداد تراکنش‌ها',latestTransactionCard:'آخرین تراکنش',currencySummaryCard:'خلاصه ارزها',cardHint:'آیکون را بکشید تا ترتیب آن عوض شود.',homeInsights:'اطلاعات سریع',homeInsightHint:'با کشیدن چپ و راست، اطلاعات بخش‌ها را ببینید.',previousInsight:'اطلاعات قبلی',nextInsight:'اطلاعات بعدی'
};

const en: Dict = {
 appName:'Cashio',tagline:'Simple offline money management',currentBalance:'Current balance',recordedOnDevice:'Data is stored on this device',
 ...
 about:'About',versionOffline:'Version 1.3.0 — personal income and expense tracking, offline and account-free.',registerIncome:'Add income',registerExpense:'Add expense',newInput:'New inflow',newOutput:'New outflow',
 ...
 privacyLocalOnly:'Financial data is stored locally for core features.',dataIntegrityNote:'Back up before resetting or replacing the device.',openSource:'Project source is available',customCategory:'Custom categories',confirmDeleteTransaction:'Delete this transaction?',languageReload:'Language changed.',selectedCurrency:'Selected currency',fontSize:'Text size',fontSmall:'Small',fontDefault:'Default',fontLarge:'Large',fontXlarge:'Extra large',fontXxlarge:'Largest',homeCards:'Home cards',addHomeCard:'Add card',moveLeft:'Move left',moveRight:'Move right',removeHomeCard:'Remove from home',restoreHomeCards:'Restore default cards',balanceCard:'Current balance',monthIncomeCard:'Current month income',monthExpenseCard:'Current month expense',monthBalanceCard:'Current month balance',topCategoryCard:'Top expense category',transactionCountCard:'Transaction count',latestTransactionCard:'Latest transaction',currencySummaryCard:'Currency summary',cardHint:'Drag an icon to change its order.',homeInsights:'Quick insights',homeInsightHint:'Swipe left or right to view the different information sections.',previousInsight:'Previous information',nextInsight:'Next information'
};

const ru: Dict = {
 ...en, appName:'Cashio', tagline:'Простой офлайн-учёт денег', currentBalance:'Текущий баланс', recordedOnDevice:'Данные хранятся на этом устройстве',
 ...
 finalDeleteWarning:'Подтверждение: все операции и пользовательские категории будут удалены.',finalDelete:'Удалить навсегда',cancel:'Отмена',about:'О программе',versionOffline:'Версия 1.3.0 — личный учёт доходов и расходов, офлайн.',registerIncome:'Добавить доход',registerExpense:'Добавить расход',newInput:'Новый доход',newOutput:'Новый расход',
...
const ar: Dict = {
 ...en, appName:'Cashio',tagline:'إدارة مالية بسيطة دون اتصال',currentBalance:'الرصيد الحالي',recordedOnDevice:'تُحفظ البيانات على هذا الجهاز',totalIncome:'إجمالي الدخل',totalExpense:'إجمالي المصروفات',transactions:'المعاملات',
 ...
 finalDeleteWarning:'تأكيد نهائي: سيتم حذف جميع المعاملات والفئات المخصصة.',finalDelete:'حذف نهائي',cancel:'إلغاء',about:'حول التطبيق',versionOffline:'الإصدار 1.3.0 — إدارة شخصية للدخل والمصروفات دون اتصال.',registerIncome:'إضافة دخل',registerExpense:'إضافة مصروف',newInput:'دخل جديد',newOutput:'مصروف جديد',
 ...
 allDataDeleted:'تم حذف جميع البيانات.',themeChanged:'تم تغيير المظهر.',currencySummary:'ملخص العملات',otherCurrencies:'عملات أخرى',noBalanceForCurrency:'لا توجد معاملات بهذه العملة بعد.',currencyNote:'كل معاملة تحتفظ بعملتها ولا يتم جمع العملات المختلفة.',noAutoConversion:'لا يوجد تحويل تلقائي لأسعار الصرف؛ تُعرض العملات بشكل منفصل.',mainNavigation:'التنقل الرئيسي',home:'الرئيسية',transactionsTab:'المعاملات',reportsTab:'التقارير',settingsTab:'الإعدادات',currencyFilter:'فلتر العملة',allCurrencies:'كل العملات',thisCurrency:'هذه العملة',privacyLocalOnly:'تُخزّن البيانات المالية محلياً للوظائف الأساسية.',dataIntegrityNote:'أنشئ نسخة احتياطية قبل إعادة ضبط الجهاز أو تغييره.',openSource:'شفرة المصدر متاحة للمشروع',customCategory:'الفئات المخصصة',confirmDeleteTransaction:'هل تريد حذف هذه المعاملة؟',languageReload:'تم تغيير اللغة.',selectedCurrency:'العملة المحددة'
};

const tr: Dict = {
 ...en, appName:'Cashio',tagline:'Basit çevrimdışı para yönetimi',currentBalance:'Güncel bakiye',recordedOnDevice:'Veriler bu cihazda saklanır',totalIncome:'Toplam gelir',totalExpense:'Toplam gider',transactions:'İşlemler',
