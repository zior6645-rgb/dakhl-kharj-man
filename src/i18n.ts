...
export type TranslationKey =
  ...
  | 'descriptionOptional'|'saveChanges'|'save'|'invalidCategory'|'invalidTime'|'descTooLong'|'saved'|'updated'
...
const fa: Dict = {
 ...
 saveChanges:'ذخیره تغییرات',save:'ثبت',invalidCategory:'دسته‌بندی معتبر نیست.',invalidTime:'ساعت نامعتبر است.',descTooLong:'توضیح بیش از حد طولانی است.',saved:'تراکنش ثبت شد.',updated:'تراکنش ویرایش شد.',deleted:'تراکنش حذف شد.',
 ...
 privacyLocalOnly:'داده‌های مالی برای قابلیت اصلی در همین دستگاه نگهداری می‌شوند.',dataIntegrityNote:'قبل از تعویض یا پاک‌سازی دستگاه، پشتیبان بگیرید.',openSource:'متن‌باز',languageReload:'زبان برنامه تغییر کرد.',selectedCurrency:'ارز انتخاب‌شده'
};
...
const en: Dict = {
 ...
 saveChanges:'Save changes',save:'Save',invalidCategory:'Invalid category.',invalidTime:'Invalid time.',descTooLong:'Description is too long.',saved:'Transaction saved.',updated:'Transaction updated.',deleted:'Transaction deleted.',
 ...
 privacyLocalOnly:'Financial data is stored locally for core features.',dataIntegrityNote:'Back up before resetting or replacing the device.',openSource:'Open source',languageReload:'Language changed.',selectedCurrency:'Selected currency'
};
...
const ru: Dict = {
 ...
 amount:'Сумма',amountExample:'например, 2500.00',title:'Название',titleExample:'например, Зарплата',category:'Категория',select:'Выберите…',date:'Дата',time:'Время',descriptionOptional:'Описание (необязательно)',saveChanges:'Сохранить изменения',save:'Сохранить',invalidCategory:'Недопустимая категория.',invalidTime:'Недопустимое время.',descTooLong:'Описание слишком длинное.',
...
const ar: Dict = {
 ...
 allDataDeleted:'تم حذف جميع البيانات.',themeChanged:'تم تغيير المظهر.',currencySummary:'ملخص العملات',otherCurrencies:'عملات أخرى',noBalanceForCurrency:'لا توجد معاملات بهذه العملة بعد.',currencyNote:'كل معاملة تحتفظ بعملتها ولا يتم جمع العملات المختلفة.',noAutoConversion:'لا يوجد تحويل تلقائي لأسعار الصرف؛ تُعرض العملات بشكل منفصل.',mainNavigation:'التنقل الرئيسي',home:'الرئيسية',transactionsTab:'المعاملات',reportsTab:'التقارير',settingsTab:'الإعدادات',currencyFilter:'فلتر العملة',allCurrencies:'كل العملات',thisCurrency:'هذه العملة',privacyLocalOnly:'تُخزّن البيانات المالية محلياً للوظائف الأساسية.',dataIntegrityNote:'أنشئ نسخة احتياطية قبل إعادة ضبط الجهاز أو تغييره.',openSource:'مفتوح المصدر',languageReload:'تم تغيير اللغة.',selectedCurrency:'العملة المحددة'
};
...
const tr: Dict = {
 ...
 about:'Hakkında',versionOffline:'Sürüm 1.1.0 — kişisel gelir-gider takibi, çevrimdışı.',registerIncome:'Gelir ekle',registerExpense:'Gider ekle',newInput:'Yeni giriş',newOutput:'Yeni çıkış',amount:'Tutar',amountExample:'ör. 2500,00',title:'Başlık',titleExample:'ör. Maaş',category:'Kategori',select:'Seçin…',date:'Tarih',time:'Saat',descriptionOptional:'Açıklama (isteğe bağlı)',saveChanges:'Değişiklikleri kaydet',save:'Kaydet',invalidCategory:'Geçersiz kategori.',invalidTime:'Geçersiz saat.',descTooLong:'Açıklama çok uzun.',
