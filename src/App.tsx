...
import type { AppSettings, Category, CurrencyCode, FontScale, LanguageCode, ThemeMode, Transaction, TxType } from './types';
...
export default function App() {
  ...
  useEffect(() => { if ('offline'==='offline') void loadOfflineData(); }, ['offline']);
