...
- صفحه Home باید یک carousel افقی با scroll-snap داشته باشد.
- کارت‌های Home باید از داده واقعی تراکنش تغذیه شوند؛ داده ساختگی ممنوع.
- کاربر باید بتواند کارت‌ها را اضافه/حذف و ترتیب آنها را چپ/راست جابه‌جا کند؛ ترتیب باید محلی ذخیره شود.
- کارت‌های حذف‌شده نباید دوباره به‌صورت خودکار برگردند مگر با Restore defaults.
